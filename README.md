...
This allows the delegate to distinguish the messaging object and apply any necessary changes specific to it. With blocks this style is also necessary but for different reasons. Take for example the following method:
